...
module.exports.getTailwindConfig = function getTailwindConfig(route) {
  const defaultTailwindConfig = route.isAdmin
    ? require(CONSTANTS.ROOTPATH + '/src/modules/cms/services/tailwind.admin.config.js')
    : require(CONSTANTS.ROOTPATH + '/src/modules/cms/services/tailwind.frontStore.config.js');
