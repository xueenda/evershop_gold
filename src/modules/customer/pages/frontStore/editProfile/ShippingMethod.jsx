...
export default function ShippingMethods({
  ...
  React.useEffect(() => {
    async function saveMethods() {
      ...
      const response = await axios.post(setShippingMethodApi, {
...
ShippingMethods.propTypes = {
  ...
  setShippingMethodApi: PropTypes.string.isRequired,
  ...
  customerShippingMethod: PropTypes.shape({
...
export const query = `
  query Query {
    getMethodsAPI: url(routeId: "getCustomerShippingMethods")
    setShippingMethodApi: url(routeId: "setCustomerShippingMethod")
    allowedCountries  {
      code
      name
      provinces {
